...
router.post( '/firstmedicalexam', ( req, res ) => {
    ...
    // db.query(
    //     "INSERT INTO tbl_first_medical_examination(`examination_id`, `candidate_id`, `height`, `weight`, `body_mass_index`, `blood_pressure`, `pulse`, `pr`, `unaided_distant_rt_eye`, `unaided_distant_lt_eye`, `aided_distant_rt_eye`, `aided_distant_lt_eye`, `unaided_near_rt_eye`, `unaided_near_lt_eye`, `aided_near_rt_eye`, `aided_near_lt_eye`, `color_vision`, `right_ear`, `left_ear`, `insertion_date`, `insertion_time`, `insert_by`) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?); INSERT INTO logs(log_activity, logged_by, log_date, log_time) VALUES(?,?,?,?)",
